...
//       expect(dbUser).toMatchObject({ name: newUser.firstName, email: newUser.email, role: 'user', isEmailVerified: false });
...
//         email: userOne.email,
//         role: userOne.role,
//         isEmailVerified: userOne.isVerified,
//       });
...
//       const dbUser = await User.findById(userOne._id);
//       expect(dbUser).toBeDefined();
//       expect(dbUser).toMatchObject({ name: userOne.firstName, email: userOne.email, role: userOne.role, isEmailVerified: true });
//     });
