...
//       expect(dbUser).toMatchObject({ firstName: newUser.firstName, lastName: newUser.lastName, email: newUser.email, role: newUser.role, isVerified: false });
//     });
...
//       expect(dbUser).toMatchObject({ firstName: updateBody.firstName, email: updateBody.email, role: 'user' });
//     });
